...
[Precision_T2I,map(1, 2),Recall_T2I] = mAP_2(simti,label_tr,label_te);
[Precision_I2T,map(1, 3),Recall_I2T] = mAP_2(simit,label_tr,label_te);
...
name_I2T=['./Results/PR_curves/CCA_PRcurve_I2T',num2str(Rd_dimension),'.mat'];
name_T2I=['./Results/PR_curves/CCA_PRcurve_T2I',num2str(Rd_dimension),'.mat'];
% curve=Precision_I2T;
save(name_I2T,'Precision_I2T','Recall_I2T')
% curve=Precision_T2I;
save(name_T2I,'Precision_T2I','Recall_T2I')

name_top_points_I2T=['./Results/Top_retrieved_points/CCA_points_I2T',num2str(Rd_dimension),'.mat'];
name_top_points_T2I=['./Results/Top_retrieved_points/CCA_points_T2I',num2str(Rd_dimension),'.mat'];
