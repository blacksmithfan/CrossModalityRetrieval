function [ T2I_map,I2T_map ] = function_CCA_finetune( Rd_dimension )
...
name_I2T=['./Results/PR_curves/DeepNet_CCA_PRcurve_I2T',num2str(Rd_dimension),'.mat'];
name_T2I=['./Results/PR_curves/DeepNet_CCA_PRcurve_T2I',num2str(Rd_dimension),'.mat'];
curve=info_i2t.ap_11pt;
save(name_I2T,'curve')
curve=info_t2i.ap_11pt;
save(name_T2I,'curve')

name_top_points_I2T=['./Results/Top_retrieved_points/DeepNet_CCA_points_I2T',num2str(Rd_dimension),'.mat'];
name_top_points_T2I=['./Results/Top_retrieved_points/DeepNet_CCA_points_T2I',num2str(Rd_dimension),'.mat'];
